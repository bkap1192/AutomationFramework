...
public class EditPRInvoiceNumber 
{
	...
	@FindBy(xpath="//input[@name='cusReceiptNo']")
	...
	public String fn_verifyPageHeader()
	{
		try
		{
		String str=GenericClass.getText(page_header);
		return str;
		}
		catch(Exception e)
		{
	...
	public void fn_verifyElements() throws Exception
	{
		try
		{
	...
	public InvoiceNumberSettingsLP fn_editFDPrefix(int iTestCaseRow) throws Exception
	{
		try
		{
	...
	public void fn_fillPRDetails(int iTestCaseRow) throws Exception
	{
		try
		{
		GenericClass.sendKeys(txtbox_Prefix, ExcelUtil.getCellData(iTestCaseRow, ExcelUtil.GetColumnIndex(Constant.Col_Prefix)));
