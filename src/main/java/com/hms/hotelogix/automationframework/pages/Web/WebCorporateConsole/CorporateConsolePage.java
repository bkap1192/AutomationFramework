...
public class CorporateConsolePage {
	...
	public CorporateSelectRoomPage fn_CheckAvability() throws Exception
	{
        ...
        CorporateSelectRoomPage CRSP =  PageFactory.initElements(GenericClass.driver, CorporateSelectRoomPage.class);
        return CRSP;
